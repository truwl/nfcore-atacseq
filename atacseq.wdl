...
command <<<
        python <<CODE
        import uuid
        print("gs://truwl-internal-inputs/nf-atacseq/{}".format(str(uuid.uuid4())))
        CODE
>>>
...
task run_nfcoretask {
    ...
    runtime {
        docker: "truwl/nfcore-atacseq:1.2.1_0.1.0"
        memory: "2 GB"
        cpu: 1
    }
}
